...
%Initial constraints on population
opti.subject_to((X(1, 1)^2) + (X(2, 1)^2)  == 1);
opti.subject_to((X(3, 1)^2) + (X(4, 1)^2)  == 0);

%Terminal constraints on population
opti.subject_to((X(1, end)^2) + (X(2, end)^2)  == 0);
opti.subject_to((X(3, end)^2) + (X(4, end)^2)  == 1);
